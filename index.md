...
привязку, сопоставить скорости._
     * Дополнительные материалы к разделу [log prediction](./log_prediction.html)
...
*Используемые инструменты: Python, Wolfram Language, Excel, tNavigator*
...
*Используемые инструменты: Python, Wolfram Language, Excel*
