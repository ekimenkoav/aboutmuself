...
Программа обучения предполагает подгоовку докладов и защиту выбранной темы. 
...
a.	В интернете прочитать про моделирование на основе свёрточной модели трассы
b.	Рассказать для чего используется такое моделирование
c.	Показать реализацию в эксель (минимум) и любом языке программирования (желательно) включая: 
i.	перевод данных во временной масштаб,
ii.	 формирование сигнала, 
iii.	свёртка. 

d.	Сделать модель клина – показать при какой мощности пласта отражения от кровли и подошвы фиксируются отдельно. 

e.	Рассказать об ограничениях свёрточной модели (например, можно ли моделировать кратные волн, можно ли моделировать разломы)
