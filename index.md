...
привязку, сопоставить скорости._
     * Дополнительные материалы к разделу [краткая информация](./log_prediction.html).
...
Материал подготвлен в соавторстве с [Беловым Кириллом] (https://github.com/KirillBelovTest).
